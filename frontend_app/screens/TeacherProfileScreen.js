        ...
        <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.header}>
                <View style={styles.avatarContainer}>
                    <Ionicons name="school" size={48} color={colors.textWhite} />
                </View>
            ...
            <View style={styles.section}>
                ...
                <View style={styles.menuContainer}>
                    ...
                    <MenuItem
                        ...
                        subtitle="Manage bank accounts and withdrawals"
                        onPress={() => navigation.navigate('TeacherWallet')} // Corrected route name
                    />
                    <MenuItem
...
const styles = StyleSheet.create({
    ...
    avatarContainer: {
        ...
        height: 100,
        borderRadius: 50,
        backgroundColor: colors.warning, // Different color for teacher
